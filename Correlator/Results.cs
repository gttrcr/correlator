...
namespace Correlator
{
    public class Result
    {
        ...
        public IDictionary<string, object>? Arguments { get => Correlator.Arguments.Get().Args; }
        ...
        public void Save()
        {
            ...
            Directory.CreateDirectory(Correlator.Arguments.Get().Args.Output);
            File.WriteAllText(Correlator.Arguments.Get().Args.Output + "/results.json", resString);
        }
    }
