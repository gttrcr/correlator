...
namespace analysis
{
    ...
    public:
        ...
        void save(const std::string &output_folder, const std::string &output_file) const
        {
            ...
            std::ofstream of(_args.output + "/" + output_folder + "/" + _data.source.filename + "_" + output_file);
            analysis::metadata::get()->set_analysis(output_folder, _data.source.filename + "_" + output_file);
